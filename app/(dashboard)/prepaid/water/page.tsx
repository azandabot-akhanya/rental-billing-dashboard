...
export default function WaterPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Water transaction and meter reading saved successfully!")
      setFormData({
        ...formData,
        amount: "",
        voucherNumber: "",
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Water</h2>
          <p className="text-muted-foreground">
            Record water meter readings and transactions
          </p>
        </div>
      </div>

      {/* Record Water Transaction & Meter Reading */}
      <Card>
        <CardHeader>
