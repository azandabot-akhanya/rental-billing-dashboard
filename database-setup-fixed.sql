-- ===============================================
-- FIXED DATABASE SETUP FOR RENTAL BILLING SYSTEM
...
BEGIN
    ...
    VALUES (p_company_name, p_address, p_contact_number, p_email, p_banking_details);
END //
...
BEGIN
    ...
    VALUES (
        ...
        p_notes, COALESCE(p_status, 'active')
    );
END //
...
BEGIN
    SELECT
        ...
        COALESCE(c.name, 'Deposit') as description,
        d.amount
    FROM deposits d
...
BEGIN
    SELECT
        ...
        COALESCE(c.name, 'Expense') as description,
        e.amount
    FROM expenses e
...
-- ===============================================
-- CREATE TEST USER AND COMPANY (if not exists)
-- ===============================================

INSERT INTO users (email, plain_password)
VALUES ('admin@test.com', 'password123')
ON DUPLICATE KEY UPDATE email = email;

INSERT INTO companies (company_name, address, contact_number, email)
VALUES ('Test Company', '123 Main St', '0123456789', 'info@testcompany.com')
ON DUPLICATE KEY UPDATE company_name = company_name;

SELECT 'Database setup complete! ✓' as status;
SELECT CONCAT('Test user: admin@test.com / password123') as credentials;
